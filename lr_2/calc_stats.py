...
plt.legend()
plt.tight_layout()
plt.savefig('imgs/perf_vs_N_release.png', dpi=150)
plt.show()
...
plt.xticks(M_buff)
plt.tight_layout()
plt.savefig('imgs/buffered_vs_M.png', dpi=150)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('imgs/blocked_vs_S.png', dpi=150)
plt.show()
...
plt.grid(True, which='both', linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('imgs/blocked_optimal_vs_S.png', dpi=150)
plt.show()

print("Графики сохранены в папку imgs: perf_vs_N_release.png, buffered_vs_M.png, blocked_vs_S.png, blocked_optimal_vs_S.png")